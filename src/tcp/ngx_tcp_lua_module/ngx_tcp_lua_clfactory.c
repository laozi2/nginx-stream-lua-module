...
int
ngx_tcp_lua_clfactory_loadfile(lua_State *L, const char *filename)
{
...
int
ngx_tcp_lua_clfactory_loadstring(lua_State *L, const char *s)
{
    return ngx_tcp_lua_clfactory_loadbuffer(L, s, strlen(s), s);
}


int
ngx_tcp_lua_clfactory_loadbuffer(lua_State *L, const char *buff,
